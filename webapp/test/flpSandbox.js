		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MockService Exercise",
									"targetURL": "#sapipstrainingmockserviceexercise-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingmockserviceexercise-display": {
								"semanticObject": "sapipstrainingmockserviceexercise",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.mockserviceexercise",
									"url": sap.ui.require.toUrl("sapips/training/mockserviceexercise")
								}
							}
						}
					}
